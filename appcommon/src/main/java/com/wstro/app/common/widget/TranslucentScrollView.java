...
public class TranslucentScrollView extends ScrollView {
     ...
     */
    public void setTransView(int colorId,View transView) {
        setTransView(transView, getResources().getColor(colorId), DeviceUtils.dp2px(getContext(), DFT_TRANSSTARTY), DeviceUtils.dp2px(getContext(), DFT_TRANSENDY));
    }
